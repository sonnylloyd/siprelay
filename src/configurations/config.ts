...
export class Config {
  ...
  public readonly HTTP_CORS_ORIGINS: string[] = (process.env.HTTP_CORS_ORIGINS || '')
    .split(',')
  ...
  public readonly SIP_TLS_REJECT_UNAUTHORIZED: boolean =
    process.env.SIP_TLS_REJECT_UNAUTHORIZED === '0' ? false : true;
